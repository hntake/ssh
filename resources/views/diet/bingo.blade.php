                        ...
                        <nav id="menu" class="header_nav">
                            <ul class="header_nav_list">
                                ...
                                <li class="header_nav_itm">
                                    <a href="{{ url('diet/index') }}" class="header_nav_itm_link">ビンゴ議員一覧</a>
                                ...
                                <li class="header_nav_itm">
                                    <a href="{{ url('diet/bingo') }}" class="header_nav_itm_link">ビンゴ議員</a>
                                    <div class="description1">裏金・統一教会・他不祥事全て関係する議員一覧</div>
                                </li>
                                <li class="header_nav_itm">
                                    <a href="{{ url('diet/bribe') }}" class="header_nav_itm_link">裏金</a>
                                    <div class="description1">裏金疑惑の議員がその金額順で表示されます</div>
                                </li>
                                <li class="header_nav_itm">
                                        <a href="{{ url('diet/cult') }}" class="header_nav_itm_link">統一教会</a>
