...
全ての不祥事を数値化し、議員の不祥事数をランキング表示しています。また、皆さんからの不祥事の投稿も歓迎しています。">
    ...
    <div class="wrap">
        <div class="container">
            ...
            <div class="testtable-responsive">
                ...
                @if($id=='jimin')
                <h3>自民党平均不祥事数{{$average}}</h3>
                <p>自民党 議員一覧</p>
                @elseif($id=='rikken')
                <h3>立憲民主党平均不祥事数{{$average}}</h3>
                <p>立憲民主党 議員一覧</p>
                @elseif($id=='ishin')
                <h3>日本維新の会平均不祥事数{{$average}}</h3>
                <p>日本維新の会 議員一覧</p>
                @elseif($id=='kyousan')
                <h3>日本共産党平均不祥事数{{$average}}</h3>
                <p>日本共産党 議員一覧</p>
                @elseif($id=='koumei')
                <h3>公明党平均不祥事数{{$average}}</h3>
                <p>公明党 議員一覧</p>
                <h3>自民党平均不祥事数{{$average}}</h3>
                @elseif($id=='kokumin')
                <h3>国民民主党平均不祥事数{{$average}}</h3>
                <p>国民民主党 議員一覧</p>
                @elseif($id=='reiwa')
                <h3>れいわ新選組平均不祥事数{{$average}}</h3>
                <p>れいわ新選組 議員一覧</p>
                @elseif($id=='hokkaido')
                <h3>北海道エリア平均不祥事数{{$average}}</h3>
                <p>北海道エリア議員一覧</p>
                @elseif($id=='touhoku')
                <h3>東北エリア平均不祥事数{{$average}}</h3>
                <p>東北エリア議員一覧</p>
                @elseif($id=='Nkanto')
                <h3>北関東エリア平均不祥事数{{$average}}</h3>
                <p>北関東エリア議員一覧</p>   
                @elseif($id=='Skanto')
                <h3>南関東エリア平均不祥事数{{$average}}</h3>
                <p>南関東エリア議員一覧</p>   
                @elseif($id=='tokyo')
                <h3>東京エリア平均不祥事数{{$average}}</h3>
                <p>東京エリア議員一覧</p>   
                @elseif($id=='tokai')
                <h3>東海エリア平均不祥事数{{$average}}</h3>
                <p>東海エリア議員一覧</p>   
                @elseif($id=='hokuriku')
                <h3>北陸信越エリア平均不祥事数{{$average}}</h3>
                <p>北陸信越エリア議員一覧</p>   
                @elseif($id=='kinki')
                <h3>近畿エリア平均不祥事数{{$average}}</h3>
                <p>近畿エリア議員一覧</p>
                @elseif($id=='chugoku')
                <h3>中国エリア平均不祥事数{{$average}}</h3>
                <p>中国エリア議員一覧</p>  
                @elseif($id=='shikoku')
                <h3>四国エリア平均不祥事数{{$average}}</h3>
                <p>四国エリア議員一覧</p>  
                @elseif($id=='kyuushu')
                <h3>九州エリア平均不祥事数{{$average}}</h3>
                <p>九州エリア議員一覧</p>
                @elseif($id=='bingo')
                <h3>ビンゴ議員平均不祥事数{{$average}}</h3>
                <p>裏金＆統一教会＆他不祥事有りのビンゴ議員一覧</p>   
                @elseif($id=='cult')
                <h3>統一教会関係議員平均不祥事数{{$average}}</h3>
                <p>統一教会関係議員一覧</p>   
                @elseif($id=='bribe')
                <h3>裏金議員平均不祥事数{{$average}}</h3>
                <p>裏金議員一覧</p>
                @elseif($id=='hirei')
                <h3>比例ブロック平均不祥事数{{$average}}</h3>
                <p>比例ブロック議員一覧</p>
                @else
                @endif
                <table class="table-all">
                    <ul>
                        ...
                        <!--sort button-->
                        <li>
                        <form action="{{ route('diet_party_sort',['id'=>$id]) }}" method="GET">
                                        @csrf
                                        @if(isset($select))
