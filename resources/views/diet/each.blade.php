...
<meta name="twitter:image" content="https://eng50cha.com/img/diet_banner.png">
                        ...
                        <div class="image">
                            <div class="one">
                                ...
                                <div class="bad_share">
                                    ...
                                    <a href="{{ route('bad', ['id'=>$diet->id]) }}" class="bad" id="badButton">
...
// ボタンがクリックされたときの処理
badButton.addEventListener('click', function(event) {
    // デフォルトのイベントを無効化する（ページの遷移を防止）
    event.preventDefault();
    
    // ボタンを無効にする
    badButton.disabled = true;
    // ボタンのテキストを変更する（任意）
    badButton.innerHTML = '<img src="../../img/bad_disabled.png" alt="悪いねボタン" style="width:20%; height:auto;">';

    // ボタンを再度有効にするまでの時間（ミリ秒単位、例：24時間＝86400000ミリ秒）
    var disableDuration = 86400000; 
    ...
    setTimeout(function() {
        ...
        // ボタンのテキストを元に戻す（任意）
        badButton.innerHTML = '<img src="../../img/bad.png" alt="悪いねボタン" style="width:20%; height:auto;">';
    }, disableDuration);
});
