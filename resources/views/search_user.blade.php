...
<title>ユーザー検索画面 自分の英単語テストを作って公開しよう！英語学習サイト”エイゴメ”</title>
      ...
      <div class="col-sm">
        <form method="GET" action="{{ route('search_user')}}">
          <div class="form-group row">
            ...
            <!--入力-->
            <div class="col-sm-5">
              <input type="text" name="keyword" placeholder="検索したいユーザー名を入力してください">
            </div>
  ...
  <div class="test-hover">
    ...
    <table class="table table-hover">
      ...
      <tr>
        ...
        @endif
        <td>
          <div class="button"><a href="{{ route('mypicture',['id'=>$user->id]) }}">表示</a></div>
        </td>
      </tr>
      @endforeach
    </table>
