    ...
    <body >
        <div class="top">
            ...
            <div class="rule">
                ...
                <h3 style="">
                エーゴメを利用する各生徒に特定の番号（以下、クラス番号）を登録してもらうことで、その番号を持つ生徒の利用履歴などをウェブ上で確認することが出来るシステム

                </h3>
            </div>
            <div class="monitor">
                <h2 style="font-family: 'Noto Sans JP', sans-serif;">管理者画面トップページ</h2>
                <p>まずは、利用履歴が最新順に表示されます</p>
            ...
            <div class="monitor">
                ...
                <img src="img/monitor2.png" alt="monitor2">
            </div>
            <div class="monitor">
            ...
            <h2 style="font-family: 'Noto Sans JP', sans-serif;">料金プラン</h3>
                    <img src="img/monitor6.png" alt="monitor6">
            </div>
            <div class="llco">
