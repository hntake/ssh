...
<html lang="ja">
    <head>
        ...
        <title>無料PDF適格請求書作成サイト 会員情報修正ページ</title>
...
<body>
    ...
    <div class="container home">
        <div class="button-group">
            <!-- 登録上方修正ボタン -->
            <form action="{{ route('invoice_user',['id'=>$invoice->id]) }}" method="POST" style="display:inline;">
                @csrf
                <button type="submit">請求書作成ページへ</button>
            </form>
            <!-- ログアウトボタン -->
        ...
        <div class="form">
            <h1>登録情報修正</h1>
            <form action="{{ route('update_registration_post',['id'=>$invoice->id]) }}" method="POST">
                @csrf
                <div class="r-box">
