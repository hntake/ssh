        ...
        <div class="row1">
            ...
            <table class="table5">
                <tbody>
                    ...
                    <tr>
                        <td class="left">10%対象</td>
                        <td class="right">{{ number_format((int)$ten) }}円</td>
                        <td class="center table-title bold">消費税</td>
                        <td class="right">{{ number_format((int)$ten*0.1)}}円</td>
                    </tr>
                    <tr>
                        <td class="left">8%対象</td>
                        <td class="right">{{ number_format((int)$eight) }}円</td>
                        <td class="center table-title bold">消費税</td>
                        <td class="right">{{ number_format((int)$eight*0.08)}}円</td>
                    </tr>
                </tbody>
            </table>
            <div class="address">
