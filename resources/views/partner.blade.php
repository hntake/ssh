...
<head>
    ...
    <title>パートナープログラム 英語学習サイト”エイゴメ” </title>
            ...
            <section>
                <div class="partner_logo">
                    ...
                    <div class="sales_discription">
                        ...
                        エイゴメがより多くの子供たちに活用され、誰にでも英語が身近になる、そんな未来を作っていきます。
                    </div>
                </div>
                <div class="middle-partner">
                    <a name="paid">
                        <div class="partner_logo">
                            <h2>エイゴメ <br>ディストリビュータープログラム</h2>
                        </div>
                        <div class="sales">
                            ...
                            <div class="sales_discription">
                                エイゴメの利用自体は完全無料ですが、教育機関向けにモニタリングサービスやアカウント設定などの有償プランがあります。以上のような有償プランの普及をして頂けるディストリビューターパートナーを募集しています。<br>
                                詳しくはこちらからお問い合わせください。
                    ...
                    <a name="monitor">
                        ...
                        <div class="sales">
                            ...
                            <div class="sponsor_discription">
                                エイゴメの利用は完全無料であり、学習の場に不適切な広告は掲示しない方針です。子供たちが安全に学習できる場を運営するためのサポートをして下さる広告スポンサーを募集しています。<br>
                                詳しくはこちらからお問い合わせください。
                                <div class="admin_button"><a href="{{ route('contact.index') }}" style="background-color:none; color:#7791DE;">お問い合わせページへ</a></div>
                            </div>
                        </div>
