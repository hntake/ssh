...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>エーゴメとは？ 英語学習サイト”エーゴメ” </title>
                    ...
                    <div class="header_inner">
                        ...
                        <!-- <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block"> -->
                            <ul class="header_nav_list">
                                ...
                                <a href="#feature" class="header_nav_itm_link">エーゴメ</a>
                                <div class="description1">エーゴメの概要</div>
                                </li>
                                <li class="header_nav_itm">
                                <a href="#monitor" class="header_nav_itm_link">モニタリングサービス</a>
                                <div class="description1">モニタリングサービスの概要</div>
                                </li>
                                <li class="header_nav_itm">
                                <a href="{{url('plan')}}" class="header_nav_itm_link">利用料金</a>
                                <div class="description1">有償プランについて</div>
                                </li>
