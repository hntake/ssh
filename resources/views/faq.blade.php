...
<title>FAQ 自分の英単語テストを作って公開しよう！英語学習サイト”エーゴメ” FAQ</title>
<body>
            ...
            <section>
                        ...
                        <h2 class="title"><a id="index">Q.登録後の認証メールが来ない</a></h2>
                            <div class="box">
                                ...
                                <p>2.docomo、au、softbankなど各キャリアのセキュリティ設定により受信拒否と認識されているか、迷惑メール対策などでドメイン指定受信を設定している場合に、メールが正しく届かないことがございます。@gmail.comからのメールを受信できるようにしてください。</p>
